...
// Para criar um banco de dados personalizado basta escolher um nome no final da String da url (ex: dbmendoncati)
const url = 'mongodb+srv://admin:123Senac@projetonode.4bgbm.mongodb.net/dbmendoncati'
